...
CLASS ZCL_PROD_ACH IMPLEMENTATION.
...
*      <fs_sign_staus>-designcap = 'test'.
 ...
 ENDTRY.
      ...
      IF lv_hours < 1.
        lv_hours = 1.
      ENDIF.
      if lv_hours is not INITIAL or lv_hours <> 0.
      data(design_cap) = wa_designcap-design_cap * ( 24 / lv_hours ).
      endif.

      if design_cap NE '0'.
**      <fs_sign_staus>-ProductionAchievedPercentage =  ( <fs_sign_staus>-ConfYieldQtyInProductionUnit / design_cap ) * 100.
       <fs_sign_staus>-ProductionAchievedPercentage =  ( <fs_sign_staus>-ConfYieldQtyInProductionUnit / <fs_sign_staus>-Capcity  ) * 100.
      ENDIF .
    ENDLOOP.
