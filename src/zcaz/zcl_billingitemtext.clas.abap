CLASS zcl_billingitemtext DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS billingitemtext
      IMPORTING p_billingdocument     TYPE i_billingdocumentbasic-billingdocument
                p_billingdocumentitem TYPE i_billingdocumentitembasic-billingdocumentitem
                p_textid              TYPE c
...
CLASS ZCL_BILLINGITEMTEXT IMPLEMENTATION.


  METHOD billingitemtext.
    ...
    lv_url = |https://{ lv_tenent }-api.s4hana.cloud.sap/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV/A_BillingDocumentItemText| &
              |(BillingDocument='{ p_billingdocument }',BillingDocumentItem='{ p_billingdocumentitem }',Language='EN',LongTextID='{ p_textid }')|.
