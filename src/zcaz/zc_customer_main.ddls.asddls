@ObjectModel.query.implementedBy: 'ABAP:ZCL_CUSTOMER_MAIN'
@EndUserText.label: 'Customer Ageing report'
define custom entity zc_customer_main
{
...
//      Days_366_to_999   : abap.curr(10,2);
      ...
      @EndUserText.label: 'Net Over Due'
      @Semantics.amount.currencyCode: 'Currency_Code'

      Net_over_Due          : abap.curr(10,2);
      ...
      _CHILD              : composition [*] of zmain_customer_ageing;
