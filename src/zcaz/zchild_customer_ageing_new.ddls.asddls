...
define custom entity ZCHILD_CUSTOMER_AGEING_NEW
...
//      @Semantics.amount.currencyCode: 'Currency_Code'
//      days_181_to_365   : abap.curr(16,2);
//
//
//      @UI               : {      lineItem: [ { position: 110 } ],
//           identification     : [ { position:110 } ]
...
//      totalamount       : abap.curr(10,2);
      ...
      _bomassoc         : association to parent ZC_CUSTOMER_AGEING_NEW on  $projection.Supplier_code = _bomassoc.Supplier_code
