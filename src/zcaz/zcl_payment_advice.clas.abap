CLASS zcl_payment_advice DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_PAYMENT_ADVICE IMPLEMENTATION.
...
*************Item Data
    ...
    IF partial_header IS NOT INITIAL.
      IF header-clearingjournalentry IS INITIAL.
        wa-postingdate                      = partial_header-postingdate.
        header-clearingjournalentry         = partial_header-accountingdocument.
        header-companycodecurrency          = partial_header-companycodecurrency.
        total                               = partial_header-amountincompanycodecurrency.
    ...
    WHERE supplier = @partial_header-supplier
...
*************PaymentDifference
    ...
    IF partial_header IS NOT INITIAL AND header-clearingjournalentry IS INITIAL.
      paymenttotal   = partial_header-amountincompanycodecurrency.
    ELSE.
