...
define custom entity zmain_customer_ageing

{
  ...
  key Posting_date       :  abap.dats(8); //abap.char(8);
...
//      totalamount       : abap.curr(10,2);
      ...
      _bomassoc         : association to parent zc_customer_main on  $projection.customer_code = _bomassoc.customer_code
