CLASS zcl_customer_aeging_new1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_CUSTOMER_AEGING_NEW1 IMPLEMENTATION.
...
*                wa_final-days_999 =   wa_final-days_999 + wa_main-AmountInCompanyCodeCurrency.
              ...
              IF  day_off < wa_main-cashdiscount1days.
...
SHIFT wa_final1-supplier_code LEFT DELETING LEADING '0'.
          ...
          DATA(lv_sydate1) = sy-datum.                                "wa_cust-duecalculationbasedate.
          REPLACE ALL OCCURRENCES OF '-' IN  lv_sydate WITH ''.

*          lt_diff1 =   lv_from_date1 - lv_sydate1.
          lt_diff1 =    lv_sydate1 - lv_from_date1.

          DATA(duedate1) = sy-datum.
          REPLACE ALL OCCURRENCES OF '-' IN  duedate WITH ''.
...
*              wa_final1-days_999 =   wa_final1-days_999 + wa_cust-AmountInCompanyCodeCurrency.
            ...
            ELSEIF lt_diff1 BETWEEN 181 AND 210.
              wa_final1-days_181_to_210 = wa_final1-days_181_to_210 +  wa_cust-amountintransactioncurrency.

            ELSEIF lt_diff1  BETWEEN 211 AND 240.
              wa_final1-days_211_to_240 =  wa_final1-days_211_to_240 + wa_cust-amountintransactioncurrency.

            ELSEIF lt_diff1  BETWEEN 241 AND 270.
              wa_final1-days_241_to_270 =  wa_final1-days_241_to_270 + wa_cust-amountintransactioncurrency.

            ELSEIF lt_diff1  BETWEEN 271 AND 365.
              wa_final1-days_271_to_365 =  wa_final1-days_271_to_365 + wa_cust-amountintransactioncurrency.

            ELSEIF lt_diff1 > 366.
              wa_final1-days_366 =   wa_final1-days_366 + wa_cust-amountintransactioncurrency.


            ENDIF.

            IF  day_off1 < wa_cust-cashdiscount1days.
