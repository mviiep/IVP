CLASS zcl_customer_aeging_new DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_CUSTOMER_AEGING_NEW IMPLEMENTATION.
...
SHIFT wa_final-supplier_code LEFT DELETING LEADING '0'.
          LOOP AT it_supplier_main INTO DATA(wa_main) WHERE supplier = wa_supplier-supplier .
            ...
            lv_from_date = wa_main-DocumentDate. "wa_main-PostingDate.
...
*              IF  day_off LE  0 ." wa_main-cashdiscount1days.
...
*              ENDIF.
      ...
      WHEN 'ZCHILD_CUSTOMER_AGEING_NEW'.
...
SHIFT wa_final1-supplier_code LEFT DELETING LEADING '0'.
          ...
          DATA(lv_from_date1) = wa_cust-DocumentDate. " wa_cust-PostingDate.
          REPLACE ALL OCCURRENCES OF '-' IN  lv_from_date WITH ''.
...
sort it_final1 ASCENDING by posting_date.
