...
define view entity ZI_PO_MASTER1
  as select distinct from I_SuplrInvcItemPurOrdRefAPI01 as SupplierInvoicePORef

  //    inner join   I_PurchaseOrderAPI01           as POAPI01        on SupplierInvoicePORef.PurchaseOrder = POAPI01.PurchaseOrder
  //    inner join   I_PurchaseOrderItemAPI01       as POItemAPI01    on  SupplierInvoicePORef.PurchaseOrder     = POItemAPI01.PurchaseOrder
  //                                                                  and SupplierInvoicePORef.PurchaseOrderItem = POItemAPI01.PurchaseOrderItem
  //    inner join   I_ProductPlantIntlTrd          as ProductPlant   on SupplierInvoicePORef.PurchaseOrderItemMaterial = ProductPlant.Product
  //    inner join   I_PurOrdItmPricingElementAPI01 as POItemPricing  on  SupplierInvoicePORef.PurchaseOrder     = POItemPricing.PurchaseOrder
  ...
  //    inner join   I_PurOrdItmPricingElementAPI01 as POItemPricing1 on  SupplierInvoicePORef.PurchaseOrder     = POItemPricing1.PurchaseOrder
  //                                                                  and SupplierInvoicePORef.PurchaseOrderItem = POItemPricing1.PurchaseOrderItem
  //                                                                  and POItemPricing1.ConditionType           = 'DL01'
  //    inner join   I_PurOrdItmPricingElementAPI01 as POItemPricing2 on  SupplierInvoicePORef.PurchaseOrder     = POItemPricing2.PurchaseOrder
  //                                                                  and SupplierInvoicePORef.PurchaseOrderItem = POItemPricing2.PurchaseOrderItem
  //                                                                  and POItemPricing2.ConditionType           = 'ZCES'
  //    inner join   ZI_JOURNALENTRYITEM1           as JournalItem    on  JournalItem.ReferenceDocumentMIRO = SupplierInvoicePORef.SupplierInvoice
 ...
 //  association [0..1] to I_JournalEntry           as jeheader   on JournalItem.ReferenceDocumentMIRO = jeheader.AccountingDocument 
                                                   //   and GetSupplier.AccountingDocument = jeheader.AccountingDocument


  //  JournalItem.ReferenceDocumentMIRO = SupplierInvoicePORef.SupplierInvoice
  //                                                                        and JournalItem.ReferenceDocumentItem = SupplierInvoicePORef.SupplierInvoiceItem
  //                                                                        and JournalItem.FiscalYear            = SupplierInvoicePORef.FiscalYear
