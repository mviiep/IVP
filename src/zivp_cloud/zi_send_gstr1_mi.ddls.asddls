@AbapCatalog.sqlViewName: 'ZI_SEND_GSTR1_SQ'
...
define root view ZI_SEND_GSTR1_MI 
  ...
  association [1]    to I_OperationalAcctgDocItem      as Acctgdoc        on  JournalItem.AccountingDocument = Acctgdoc.AccountingDocument
                                                                          and JournalItem.FiscalYear         = Acctgdoc.FiscalYear
  ...
  association [1]    to I_OperationalAcctgDocItem      as ProfitCenter    on  JournalItem.AccountingDocument =  ProfitCenter.AccountingDocument
                                                                          ...
                                                                          and JournalItem.FiscalYear         =  ProfitCenter.FiscalYear
  ...
  association [1]    to I_OperationalAcctgDocItem      as Cgst_gl         on  JournalItem.AccountingDocument       = Cgst_gl.AccountingDocument
                                                                          ...
                                                                          and JournalItem.TaxCode                  = Cgst_gl.TaxCode
  ...
  association [1]    to I_OperationalAcctgDocItem      as sgst_gl         on  JournalItem.AccountingDocument       = sgst_gl.AccountingDocument
                                                                          ...
                                                                          and JournalItem.TaxCode                  = sgst_gl.TaxCode
  ...
  association [1]    to I_OperationalAcctgDocItem      as igst_gl         on  JournalItem.AccountingDocument       = igst_gl.AccountingDocument
                                                                          ...
                                                                          and JournalItem.TaxCode                  = igst_gl.TaxCode
                                                                          and igst_gl.AccountingDocumentItemType   = 'T'
                                                                          and igst_gl.TransactionTypeDetermination = 'JII'

  //  association [1]    to I_JournalEntryItem             as Cgst_amo        on  JournalItem.AccountingDocument       = Cgst_amo.AccountingDocument
  //                                                                          and JournalItem.Ledgergllineitem         = Cgst_amo.LedgerGLLineItem
  //                                                                          and Cgst_gl.AccountingDocumentItemType   = 'T'
  //                                                                          and Cgst_gl.TransactionTypeDetermination = 'JIC'
  ...
  association [1]    to I_JournalEntryItem             as HSN             on  JournalItem.AccountingDocument     = HSN.AccountingDocument
                                                                          ...
                                                                          and HSN.FinancialAccountType           = 'S'
                                                                          and HSN.Ledger                         = '0L'
  ...
  association [1]    to ZI_BUYER_GSTIN                 as buyer           on  $projection.AccountingDocument = buyer.AccountingDocument
{
  ...
  key Jeheader.DocumentReferenceID,
      ...
      //      Cgst_gl.GLAccount else
      //      case when JournalItem.TaxCode <> 'V0' then
      Cgst_gl.GLAccount                                                                                                               as cgst_gl,
      //      case when JournalItem.PurchasingDocument is initial and JournalItem.TaxCode <> 'V0' then
      //      sgst_gl.GLAccount else
      //      case when JournalItem.PurchasingDocument is not initial and JournalItem.TaxCode <> 'V0' then
      //      sgst_gl.GLAccount else
      //      case when JournalItem.TaxCode <> 'V0' then
      sgst_gl.GLAccount                                                                                                               as sgst_gl,
      ...
      PO_Master.ConsumptionTaxCtrlCode  else
             ltrim( HSN.AssignmentReference, '0' )         end                                                                        as HSNCode,
      ...
      case when (JournalItem.AccountingDocumentType = 'KG' or JournalItem.AccountingDocumentType = 'KR' or
      JournalItem.AccountingDocumentType = 'RE') and JournalItem.AMCOMP < 0 then
      JournalItem.AMCOMP * -1 else
      ...
      case when JournalItem.PurchasingDocument is  initial then
      JournalItem.AMCOMP else
      JournalItem.AMCOMP end end end                                                                                                  as BaseAmount,
      ...
      case when JournalItem.TaxCode = 'A1' or JournalItem.TaxCode = 'I1' or JournalItem.TaxCode = 'B1' then
      cast(0.025 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.TaxCode = 'A2' or JournalItem.TaxCode = 'I2' or JournalItem.TaxCode = 'B2' then
      cast(0.06 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.TaxCode = 'A3' or JournalItem.TaxCode = 'I3' or JournalItem.TaxCode = 'B3' then
      cast(0.09 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.TaxCode = 'A4' or JournalItem.TaxCode = 'I4' or JournalItem.TaxCode = 'B4' then
      floor(cast(0.14 as abap.fltp) * cast(100 as abap.fltp)) else

      case when JournalItem.TaxCode = 'AA' or JournalItem.TaxCode = 'BB' or JournalItem.TaxCode = 'CC' or JournalItem.TaxCode = 'II' 
      or JournalItem.TaxCode = 'A0' or JournalItem.TaxCode = 'B0' or JournalItem.TaxCode = 'C0' or JournalItem.TaxCode = 'I0' then
      ...
      end end end end end                                                                                                             as SGST_per,
      // End of changes by krishna 30/09/24
      ...
      case when (JournalItem.AccountingDocumentType = 'KG' or JournalItem.AccountingDocumentType = 'KR' or JournalItem.AccountingDocumentType = 'RE')
      ...
      case when JournalItem.PurchasingDocument is initial
      and JournalItem.TaxCode is not initial
      and RCM_Cgst_gl.AmountInCompanyCodeCurrency is not initial then
      Cgst_gl.AmountInCompanyCodeCurrency * 0 else
      ...
      case when JournalItem.PurchasingDocument is initial and Cgst_gl.AmountInCompanyCodeCurrency is not initial
       and JournalItem.TaxCode is not initial then
      ...
      //      case when JournalItem.PurchasingDocument is not initial and Cgst_gl.AmountInCompanyCodeCurrency is not initial
      //      and JournalItem.TaxCode is not initial then //and PO_Master.CGST is not initial then
      ...
      //Start of changes krishna 30/09/24
      case when (JournalItem.AccountingDocumentType = 'KG' or JournalItem.AccountingDocumentType = 'KR' or JournalItem.AccountingDocumentType = 'RE')
      and sgst_gl.AmountInCompanyCodeCurrency is not initial
      ...
      //           case when JournalItem.PurchasingDocument is not initial and sgst_gl.AmountInCompanyCodeCurrency is not initial
      //           and JournalItem.TaxCode is not initial then   //and PO_Master.SGST is not initial then
      //                sgst_gl.AmountInCompanyCodeCurrency
      //          else
          sgst_gl.AmountInCompanyCodeCurrency
          end end end                                                                                                                 as SGST,
      ...
      case when JournalItem.TaxCode = 'A1' or JournalItem.TaxCode = 'L1' or JournalItem.TaxCode = 'B1'  then
      cast(0.025 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.TaxCode = 'A2' or JournalItem.TaxCode = 'L2' or JournalItem.TaxCode = 'B2'  then
      cast(0.06 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.TaxCode = 'A3' or JournalItem.TaxCode = 'L3' or JournalItem.TaxCode = 'B3'  then
      cast(0.09 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.TaxCode = 'A4' or JournalItem.TaxCode = 'L4' or JournalItem.TaxCode = 'B4'  then
      floor(cast(0.14 as abap.fltp) * cast(100 as abap.fltp)) else
      ...
      //      else
      cast(0 as abap.fltp) * cast(100 as abap.fltp)
      end end end end end                                                                                                             as CGST_per,
      // End of changes by Krishna 30/09/24
      ...
      case when JournalItem.TaxCode = 'A5' or JournalItem.TaxCode = 'L5' or JournalItem.TaxCode = 'B5' 
      or JournalItem.TaxCode = 'K2' then
      cast(0.05 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.TaxCode = 'A6' or JournalItem.TaxCode = 'L6' or JournalItem.TaxCode = 'B6'   then
      floor(cast(0.12 as abap.fltp) * cast(100 as abap.fltp)) else

      case when JournalItem.TaxCode = 'A7' or JournalItem.TaxCode = 'L7' or JournalItem.TaxCode = 'B7'
      or JournalItem.TaxCode = 'K1'  then
      floor(cast(0.18 as abap.fltp) * cast(100 as abap.fltp)) else

      case when JournalItem.TaxCode = 'A8' or JournalItem.TaxCode = 'L8' or JournalItem.TaxCode = 'B8'  then
      floor(cast(0.28 as abap.fltp) * cast(100 as abap.fltp)) else

      case when JournalItem.TaxCode = 'A0' or JournalItem.TaxCode = 'B0' or JournalItem.TaxCode = 'C0' or JournalItem.TaxCode = 'I0'
      then
      cast(0 as abap.fltp) * cast(100 as abap.fltp) else
      ...
      //      else
      cast(0 as abap.fltp) * cast(100 as abap.fltp)
      end end end end end                                                                                                             as IGST_per,
      // End of changes by Krishna 30/09/24
      ...
      case when JournalItem.PurchasingDocument is not initial and RCM_sgst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R1' or JournalItem.TaxCode = 'S1' then
       cast(0.025 as abap.fltp) * cast(100 as abap.fltp) else

       case when JournalItem.PurchasingDocument is not initial and RCM_sgst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R2' or JournalItem.TaxCode = 'S2' then
        cast(0.06 as abap.fltp) * cast(100 as abap.fltp) else

       case when JournalItem.PurchasingDocument is not initial and RCM_sgst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R3' or JournalItem.TaxCode = 'S3' then
      cast(0.09 as abap.fltp) * cast(100 as abap.fltp) else

       case when JournalItem.PurchasingDocument is not initial and RCM_sgst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R4' or JournalItem.TaxCode = 'S4' then
       cast(0.14 as abap.fltp) * cast(100 as abap.fltp) else
      ...
      case when JournalItem.PurchasingDocument is initial and RCM_sgst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R4' or JournalItem.TaxCode = 'S4' then
       cast(0.14 as abap.fltp) * cast(100 as abap.fltp)
       
          end end end end end end end end end                                                                                                        as RSGST_per,
      ...
      and JournalItem.TaxCode = 'R4' or JournalItem.TaxCode = 'S4' then
       cast(0.14 as abap.fltp) * cast(100 as abap.fltp)
          ...
          end end end end end end end end                                                                                                             as RCGST_per,
      ...
      case when JournalItem.PurchasingDocument is not initial and RCM_igst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R5' or JournalItem.TaxCode = 'S5' then
      cast(0.05 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.PurchasingDocument is not initial and RCM_igst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R6' or JournalItem.TaxCode = 'S6' then
      cast(0.12 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.PurchasingDocument is not initial and RCM_igst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R7' or JournalItem.TaxCode = 'S7' then
      cast(0.18 as abap.fltp) * cast(100 as abap.fltp) else

      case when JournalItem.PurchasingDocument is not initial and RCM_igst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R8' or JournalItem.TaxCode = 'S8' then
      cast(0.28 as abap.fltp) * cast(100 as abap.fltp) else
      ...
      case when JournalItem.PurchasingDocument is initial and RCM_igst_gl.AmountInCompanyCodeCurrency is not initial
      and JournalItem.TaxCode = 'R8' or JournalItem.TaxCode = 'S8' then
      cast(0.28 as abap.fltp) * cast(100 as abap.fltp)
      
      end end end end end end end end end end end end end end end end                                                                                            as RIGST_per,
      ...
      //Start of changes krishna 30/09/24
      case when (JournalItem.AccountingDocumentType = 'KG' or JournalItem.AccountingDocumentType = 'KR' or JournalItem.AccountingDocumentType = 'RE') and
      Cgst_gl.AmountInCompanyCodeCurrency is not initial and Cgst_gl.AmountInCompanyCodeCurrency < 0 then
      ceil(cast(Cgst_gl.AmountInCompanyCodeCurrency as abap.fltp) * cast(-1 as abap.fltp))
       +
      ...
      //          ceil(cast(igst_glis.AmountInCompanyCodeCurrency as abap.fltp)) else
         ...
         end end end end end                                                                                                          as TotaltaxAmount,
      ...
      //          ceil(cast(JournalItem.AMCOMP as abap.fltp))  else
         ...
         +
          ...
          +
          ceil(cast(JournalItem.AMCOMP as abap.fltp))
         end end end end end end end end end                                                                                          as Tot_Inv,
